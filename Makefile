...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -Wno-format-security \
		   -std=gnu89 -Wno-maybe-uninitialized -Wno-bool-operation -Wno-bool-operation \
                   -Wno-misleading-indentation -Wno-duplicate-decl-specifier \
                   -Wno-memset-elt-size
...
KBUILD_CFLAGS	+= -Os $(call cc-disable-warning,)
else
ifdef CONFIG_PROFILE_ALL_BRANCHES
KBUILD_CFLAGS	+= -O2 $(call cc-disable-warning,)
else
KBUILD_CFLAGS   += -O2
endif
endif
